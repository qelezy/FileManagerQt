...
ListView::ListView(QWidget *parent) : QListView(parent)
{
    ...
    contextMenu->setStyleSheet("QMenu { border: 1px solid rgb(67, 70, 80); border-radius: 5px; background-color: rgb(48, 51, 61); padding: 5px; } QMenu::item { color: white; border-radius: 5px; padding: 5px; } QMenu::item:selected { background-color: rgb(68, 71, 81); } QMenu::icon { padding-right: 10px; } QMenu::separator { height: 1px; margin-top: 5px; margin-bottom: 5px; background-color: rgb(67, 70, 80); }");
